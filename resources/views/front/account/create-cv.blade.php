            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card border-0 shadow mb-4">
                        <form action="{{ route('account.storeCV') }}" method="POST" id="cvForm" name="cvForm">
                            @csrf
                            <div class="card-body p-4">
                                <h3 class="fs-4 mb-1">Create Your CV</h3>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="objective" id="objective" class="form-control" rows="3" placeholder="Describe your career objective..."></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>

                                <div class="mb-4">
                                    <label for="skills" class="mb-2">Skills*</label>
                                    <textarea name="skills" id="skills" class="form-control" rows="4" placeholder="List your skills (e.g., HTML, CSS, JS, Laravel)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>
 
                                <div class="mb-4">
                                    <label for="experience" class="mb-2">Experience*</label>
                                    <textarea name="experience" id="experience" class="form-control" rows="4" placeholder="Describe your work experience (e.g., Worked at XYZ Company as an intern)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>

                                <div class="mb-4">
                                    <label for="education" class="mb-2">Education*</label>
                                    <textarea name="education" id="education" class="form-control" rows="4" placeholder="List your education (e.g., BSc. Hons Computing, London Metropolitan University)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>

                                <div class="mb-4">
                                    <label for="certifications" class="mb-2">Certifications (if any)</label>
                                    <textarea name="certifications" id="certifications" class="form-control" rows="3" placeholder="List any certifications you have (e.g., Laravel Certification – Udemy)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>

                                <div class="mb-4">
                                    <label for="languages" class="mb-2">Languages Known</label>
                                    <textarea name="languages" id="languages" class="form-control" rows="2" placeholder="List languages you know (e.g., English, Nepali, Hindi)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>

                                <div class="mb-4">
                                    <label for="references" class="mb-2">References</label>
                                    <textarea name="references" id="references" class="form-control" rows="3" placeholder="Provide references (e.g., Mr. XYZ, Manager, ABC Company – xyz@company.com)"></textarea>
                                    <p class="text-danger error-message"></p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="url" name="github_link" id="github_link" placeholder="Enter your GitHub link" class="form-control">
                                    <p class="text-danger error-message"></p>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="url" name="linkedin_link" id="linkedin_link" placeholder="Enter your LinkedIn link" class="form-control">
                                    <p class="text-danger error-message"></p>
                                </div>
