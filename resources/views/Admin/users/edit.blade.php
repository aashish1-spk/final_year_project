                        ...
                        <form action="{{ route('admin.users.update', $user->id) }}" method="post" id="userForm">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="designation" id="designation" placeholder="Designation" class="form-control @error('designation') is-invalid @enderror" value="{{ old('designation', $user->designation) }}">
                                    @error('designation')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-4">
                                    <label for="mobile" class="mb-2">Mobile (Optional, 10 Digits)</label>
                                    <input type="text" name="mobile" id="mobile" placeholder="Mobile" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('mobile', $user->mobile) }}">
                                    @error('mobile')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
